    ...
    <section className="bg-white py-8 sm:py-12 md:py-16 lg:py-[60px]">
      ...
      <div className="block sm:hidden w-full">
        ...
        <div className="px-[16px] text-center">
          ...
          <h2
            className="text-black text-[24px] leading-[120%] tracking-[-1px]"
            style={{
              fontFamily: "Archivo",
              fontWeight: 800,
            }}
          >
            Why we built Procevia
          </h2>

          <p
            className="h-[96px] mx-auto mt-[18px] w-[361px]  text-[#757575] text-[14px] leading-[130%]"
            style={{
              fontFamily: "ArialCustom",
              fontWeight: 400,
            }}
          >
            Digital Marketing Agencies Face Constant Operational
            Challenges — Managing Multiple Clients, Coordinating
            With Editors, Handling Feedback, And Tracking Progress
            Across Different Tools. These Fragmented Workflows
            Lead To Delays, Miscommunication, And Unnecessary
            Complexity.
          </p>
        </div>

        {/* CARDS */}
        <div className="mt-[52px] flex flex-col gap-[12px] px-[12px]">
          ...
          {cards.map((card) => (
            ...
            >
              {/* CONTENT */}
              <div className="relative z-10 h-[26px] w-[259px]">

                <h3
                  className="text-black text-[20px] leading-[118%]"
                  style={{
                    fontFamily: "Geist",
                    fontWeight: 600,
                    letterSpacing: "-0.8px",
                ...
                <p
                  className="mt-[18px] text-[#7A7A7A] text-[14px] leading-[135%]"
                  style={{
                    fontFamily: "ArialCustom",
                    fontWeight: 400,
                  }}
              ...
              >
                <Image
                  ...
                  width={260}
                  height={260}
                  className="w-[261px] h-[261px] object-contain"
                />
              </div>
            </div>
          ))}
